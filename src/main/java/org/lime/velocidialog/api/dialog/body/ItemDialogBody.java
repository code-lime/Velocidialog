package org.lime.velocidialog.api.dialog.body;
 ...
 * <p>Created via {@link DialogBody#item(HoverEvent.ShowItem, PlainMessageDialogBody, boolean, boolean, int, int)}</p>
 */
