...
public sealed interface DialogAction permits DialogAction.CommandTemplateAction, DialogAction.CustomClickAction, DialogAction.StaticAction {
     ...
     * {@code variable_name} should correspond to a {@link org.lime.velocidialog.api.dialog.input.DialogInput#key()}.
     *
     ...
     * Each {@link org.lime.velocidialog.api.dialog.input.DialogInput#key()} is added
